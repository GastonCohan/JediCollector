  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 bg-gray-100">
        <View className="p-5 border-b border-[#1b3f54] bg-white shadow-xs">
          <View>
          ...
          >
            <XCircleIcon height={50} width={50} color={"#1b3f54"} />
          </TouchableOpacity>
        </View>
        ...
        <View className="flex-row items-center space-x-4 p-4 py-3 bg-white my-5">
          ...
          <TouchableOpacity>
            <Text className="text-[#1b3f54]">Change</Text>
          </TouchableOpacity>
        </View>
        ...
        <ScrollView className="divide-y divide-gray-200">
          {Object.entries(groupedItemsInBasket).map(([key, items]) => (
            ...
            >
              <Text className="text-[#1b3f54]">{items.length} x </Text>
              <Image
              ...
              >
                <Text className="text-[#1b3f54] text-xs">Remove</Text>
              </TouchableOpacity>
            </View>
          ))}
        </ScrollView>
        ...
        <View className="p-5 bg-white mt-5 space-y-4">
          ...
          <View className="flex-row justify-between">
            ...
            <Text className="font-extra-bold">${(300 - 5.99).toFixed(2)}</Text>
          </View>

          <TouchableOpacity
            className="rounded-lg bg-[#1b3f54] p-4"
